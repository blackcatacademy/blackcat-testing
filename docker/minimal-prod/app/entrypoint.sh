...
TIMEOUT_SEC="${BLACKCAT_TRUST_TIMEOUT_SEC:-3}"
ENFORCEMENT="${BLACKCAT_TRUST_ENFORCEMENT:-strict}"
RELEASE_REGISTRY="${BLACKCAT_RELEASE_REGISTRY:-0x22681Ee2153B7B25bA6772B44c160BB60f4C333E}"
INSTANCE_FACTORY="${BLACKCAT_INSTANCE_FACTORY:-0x92C80Cff5d75dcD3846EFb5DF35957D5Aed1c7C5}"
...
export CHAIN_ID RPC_ENDPOINTS RPC_QUORUM MODE MAX_STALE_SEC TIMEOUT_SEC ENFORCEMENT
export RELEASE_REGISTRY INSTANCE_FACTORY INSTANCE_CONTROLLER
...
php -r '
  ...
  $cfg = [
    ...
    "trust" => [
      "enforcement" => (string) getenv("ENFORCEMENT"),
      "integrity" => [
        "root_dir" => $rootDir,
      ...
      "web3" => [
        ...
        "contracts" => [
          "release_registry" => (string) getenv("RELEASE_REGISTRY"),
          "instance_factory" => (string) getenv("INSTANCE_FACTORY"),
